...
function main() {
	...
	console.log("difference:", difference(new Date("2022/12/30"), new Date(), "day"));
...
function createUTCDates() {
	...
	console.log("convert local time to UTC time:", dayjs().utc().format()); // 2019-03-06T09:11:55Z
}
...
function getDetails() {
	const date = dayjs().hour(12).year(2000);
