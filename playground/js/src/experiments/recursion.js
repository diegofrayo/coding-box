...
log("numberOfDigits", numberOfDigits, [[5], [0], [1], [9], [10], [11], [1000], [100100]]);
...
log("reverseNumber", reverseNumber, [[0], [1], [10], [1010], [10000], [10003464]]);
...
log("fibonacciWithLoops", fibonacciWithLoops, [[0], [1], [2], [3], [4], [5], [6], [7]]);
// 0, 1, 1, 2, 3, 5, 8, 13
...
function isArrayOfArray(array) {
	return Array.isArray(array) && array.filter(Array.isArray).length === array.length;
}
